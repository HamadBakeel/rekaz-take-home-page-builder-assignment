...
const SectionTemplateCard = memo<SectionTemplateCardProps>(
...
export const SectionLibraryClient = memo<SectionLibraryClientProps>(
  ({ templates }) => {
    ...
    return (
      <div className="space-y-6">
        {categoryEntries.map(([category, categoryTemplates]) => {
          const isCollapsed = isMobile && collapsedCategories[category];
          ...
          return (
            <div key={category} className="space-y-3">
              <div
                ...
                onClick={isMobile ? () => toggleCategory(category) : undefined}
              >
